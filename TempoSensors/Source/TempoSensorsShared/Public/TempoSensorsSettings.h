...
public:
	...
	TObjectPtr<UMaterialInterface> GetCameraPostProcessMaterialWithInstances() const { return CameraPostProcessMaterialWithInstances.LoadSynchronous(); }
...
private:
	...
	UPROPERTY(EditAnywhere, Config, Category="Camera", meta=( AllowedClasses="/Script/Engine.BlendableInterface", Keywords="PostProcess" ))
	TSoftObjectPtr<UMaterialInterface> CameraPostProcessMaterialWithInstances;
