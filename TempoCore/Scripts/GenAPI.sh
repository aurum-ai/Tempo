...
||||||| parent of 56bdf20 (Instance vs label switch)
=======
pip install curio==1.6 --quiet --retries 0 # One --quiet to suppress warnings but show errors
pip install grpcio==1.68.1 --quiet --retries 0 # One --quiet to suppress warnings but show errors
>>>>>>> 56bdf20 (Instance vs label switch)
set -e
